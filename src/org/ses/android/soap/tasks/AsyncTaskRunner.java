 ...
 *
 */
public class AsyncTaskRunner extends  AsyncTask<String,String,Login>{
...
//			SoapPrimitive resSoap =(SoapPrimitive)envelope.getResponse();
            ...
            log.CodigoUsuario = Integer.parseInt(ic.getProperty(0).toString());;
            log.Mensaje = ic.getProperty(1).toString();
			...
			Log.i("login", "doInBackground_resp:" + resp);
             ...
             ex.printStackTrace();
             log.Mensaje =  "Error on soapPrimitiveData() " + ex.getMessage();
			 resp = log;
		 } catch (Exception e) {
			Log.e("Error : " , "Error on soapPrimitiveData() " + e.getMessage());
			e.printStackTrace();
            log.Mensaje =  "Error on soapPrimitiveData() " + e.getMessage();
            resp = log;
		 }

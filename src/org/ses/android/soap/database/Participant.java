...
public class Participant implements KvmSerializable, Parcelable {
    ...
    /**
     * Returns the patient's first name in title case. e.g. "JUAN" becomes "Juan".
     */
    public String getNombresTitleCase() {
        return Participant.toTitleCase(Nombres);
    }

    /**
     * Returns the patient's full name (first, maternal, paternal) in title case.
     */
    public String getFullNameTitleCase() {
        return Participant.toTitleCase(
